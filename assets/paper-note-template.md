...
- **Claims vs evidence:** WHAT THEY CLAIM vs WHAT THEY ACTUALLY SHOW (cite section/figure).
- **Holds up:** SPECIFIC STRENGTH.
- **Shaky:** SPECIFIC, SUBSTANTIATED WEAKNESS (eval gap, missing baseline, stats, reproducibility).

<!-- Deep tier only — delete this block on Scan/Standard notes -->
> [!warning] Pre-mortem (deep tier)
> Most likely reason this fails to replicate: REASON. Does the paper rule it out? YES/NO/PARTLY.
...
<!-- Deep tier only -->
**What's really new (first-principles, one sentence, no adjectives):** ...
...
## Next action
ONE SMALL, SPECIFIC THING — e.g. clone repo and run X / try method on DATASET / reproduce the headline number / email author about Y.

## What would change my verdict
- QUESTION 1 whose answer would flip the assessment.
- QUESTION 2.
